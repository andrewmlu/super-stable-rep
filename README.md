...
The original StableRep repository can be found in the syn-rep-main folder, while the implementation of SuperStableRep is in the super-stable-rep-main folder.
